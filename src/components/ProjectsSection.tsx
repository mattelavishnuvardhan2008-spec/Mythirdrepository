...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    ...
    >
      <motion.div
        style={{ scale }}
        className="w-full h-full rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-4 sm:p-6 md:p-8 flex flex-col gap-6 md:gap-8 origin-top"
      >
        {/* Top row */}
        ...
        <div className="flex flex-row gap-3 md:gap-4 flex-1 min-h-0">
