  ...
  return (
    <section className="relative h-screen flex flex-col" style={{ overflowX: 'clip' }}>
      ...
      <FadeIn delay={0} y={-20} as="nav">
        <div className="flex flex-row justify-between px-6 md:px-10 pt-6 md:pt-8">
          {NAV_LINKS.map((link) => (
            <a
              key={link}
      ...
      {/* Bottom bar */}
      <div className="mt-auto flex flex-row justify-between items-end px-6 md:px-10 pb-7 sm:pb-8 md:pb-10 relative z-20">
